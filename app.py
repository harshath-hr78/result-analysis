...
def usnsFile():  
    if request.method == 'POST':  
        ...
        os.chdir(r'C:\Users\harsh\Desktop\Project\input')
        f.save(f.filename)
...
def run_script():
    ...
    p = subprocess.Popen(['python','formfill.py'], stdout=subprocess.PIPE, bufsize=1)
...
def plot_csv():
    try:
        return send_file(
            r'C:\Users\harsh\Desktop\Project\result\student_marks.xlsx',
            mimetype='text/csv',
