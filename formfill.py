...
def fillLoginpage(usn, subject_codes, result_link):
    ...
    myScreenshot.save(r'C:\Users\harsh\Desktop\Project\pics\captcha_img.png') #change according to your dir.

    os.chdir(r'C:\Users\harsh\Desktop\Project')
    img = cv.imread(r'pics\captcha_img.png',0)
    ret,thresh = cv.threshold(img,103,150,cv.THRESH_TOZERO_INV)
    os.chdir(r'C:\Users\harsh\Desktop\Project\pics')
    ...
    try:
        ...
        try :
            ...
            with open(r'C:\Users\harsh\Desktop\Project\result\marks.csv', 'a',) as f:
                write = csv.writer(f)
                marks_list.append("NA")
                write.writerow(marks_list)
            csv_read = pd.read_csv(r'C:\Users\harsh\Desktop\Project\result\marks.csv')
            csv2excel = pd.ExcelWriter(r'C:\Users\harsh\Desktop\Project\result\student_marks.xlsx')
...
def main():
    ...
    f = open(r"C:\Users\harsh\Desktop\Project\result\marks.csv", "w")
    f.truncate()
    f.close()

    ite=0
    resultLinkfile = open(r"C:\Users\harsh\Desktop\Project\input\link.txt", "r")
    result_link = resultLinkfile.readline()
    #print(result_link)
    resultLinkfile.close()

    student_usn = []
    file = open(r'C:\Users\harsh\Desktop\Project\input\student_usn.csv')
    ...
    headerList = ['USN']
    subject_codes = []
    file = open(r'C:\Users\harsh\Desktop\Project\input\codes.csv')
    csvreader = csv.reader(file)
    ...
    with open(r'C:\Users\harsh\Desktop\Project\result\marks.csv', 'a') as file:
